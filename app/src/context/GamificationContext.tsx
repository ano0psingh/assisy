...
const DEFAULT_ACHIEVEMENTS: Achievement[] = [
  ...
  },
  {
    ...
    description: '60-day task streak',
    type: 'streak',
    icon: '🛡️',
  ...
  {
    id: 'planner-consistency',
    name: 'Planner Consistency',
    description: 'Plan your day 14 times',
    type: 'milestone',
    icon: '🗓️',
    requirement: { type: 'days_planned', value: 14 },
    xpReward: 200,
    isUnlocked: false,
  },
  {
    ...
    description: 'Plan your day 100 times',
    type: 'milestone',
    icon: '🏛️',
    requirement: { type: 'days_planned', value: 100 },
    xpReward: 1200,
    isUnlocked: false,
  },
  ...
  },
  {
    ...
    description: 'Have 30 productive days',
    type: 'special',
    icon: '📈',
    requirement: { type: 'productive_days', value: 30 },
    xpReward: 750,
    isUnlocked: false,
  },
  {
    id: 'productive-legend',
    name: 'Productivity Legend',
    description: 'Have 100 productive days',
    type: 'special',
    icon: '⚡',
    requirement: { type: 'productive_days', value: 100 },
    xpReward: 2000,
    isUnlocked: false,
  },
